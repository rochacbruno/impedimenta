...
int main(void)
{
	char string1[20] = "I Love Isograms";		// Create two strings to compare
	char string2[20] = "I Love Isograms";

	if(strcmp(string1, string2))			// Check to see if the two strings are equal, and print out a corresponding message.
