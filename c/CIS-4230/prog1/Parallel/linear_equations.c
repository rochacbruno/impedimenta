...
static void elimination(
    ...
    for(int i = 0; i < size - 1; i++) {
        ...
        // 1. Create a single set of persistent tasks, and resuse them here.
        //    You'd spend less time creating and destroying variable, and more
        //    time assigning values and doing work. I tried doing this, but
        //    broke my program in the process. (runtime significantly improved,
        //    though!)
        // 2. Do not pthread_mutex_lock on every single task. Instead, ask the
        //    thread pool if all workers are idle. The thread pool does not
