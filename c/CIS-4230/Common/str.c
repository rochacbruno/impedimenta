 ...
 * string_destroy() on a string that has never had string_init() called on it.
 *
 ...
 * reinitialize it with string_init(). Note that it is not an error to call string_destroy() on
 * a string for which string_init() failed. However, if string_init() fails, calling
