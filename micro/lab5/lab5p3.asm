...
; Blink LED 6 once at 10 Hz and start over again
	lda	PTBD
...
;/*------------------------------------/
; RTI: Blink LED 5 at 20Hz, once every 32 ms
;/------------------------------------*/
MY_RTI

	lda	PTAD
	bit	#%00001000	; check if switch 3 is pressed
	bne	MY_RTI_NOBLINK	; If switch not pressed in, skip ahead
