/////////////////////////////////////////////////////////
// These have been modified by St.Denis  (Nov. 2008)
// to work with the LCD_Encoder boards.
/////////////////////////////////////////////////////////
...
#define LCD_D4          PTBD_PTBD2    // LCD data D4 pin
#define LCD_D4_DIR      PTBDD_PTBDD2  // LCD data D4 pin direction
#define LCD_D5          PTBD_PTBD3    // LCD data D5 pin
#define LCD_D5_DIR      PTBDD_PTBDD3  // LCD data D5 pin direction
#define LCD_D6          PTBD_PTBD4    // LCD data D6 pin
#define LCD_D6_DIR      PTBDD_PTBDD4  // LCD data D6 pin direction
#define LCD_D7          PTBD_PTBD5    // LCD data D7 pin
#define LCD_D7_DIR      PTBDD_PTBDD5  // LCD data D7 pin direction 
#endif
...
/*-============================================================================/
Takes a character as its argument, prints out its ASCII value.
/============================================================================-*/
void LCD_numchar_out(char asciiChar) {
    int fourBits = 0;
    
    fourBits = asciiChar & 0xF0;
    fourBits = fourBits >> 4;
    LCD_numint_out(fourBits);
    fourBits = asciiChar & 0x0F;
    LCD_numint_out(fourBits);
}