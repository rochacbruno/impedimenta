...
tmux send-keys -t 5 'export PULP_SMASH_CONFIG_FILE=rhel-6-8-pulp-2-13.json' C-m
tmux send-keys -t 6 'export PULP_SMASH_CONFIG_FILE=rhel-7-3-pulp-2-12.json' C-m
tmux send-keys -t 7 'export PULP_SMASH_CONFIG_FILE=rhel-7-3-pulp-2-13.json' C-m
