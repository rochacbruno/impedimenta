...
# tmux send-keys -t 4 'export PULP_SMASH_CONFIG_FILE=rhel-6-8-pulp-2-13.json' C-m
tmux send-keys -t 4 'export PULP_SMASH_CONFIG_FILE=rhel-7-3-pulp-2-12.json' C-m
tmux send-keys -t 5 'export PULP_SMASH_CONFIG_FILE=rhel-7-3-pulp-2-13.json' C-m
