...
public class LibraryMode extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        statusRow1.setText("LibraryMode");
    ...
    public void controlModeStarted(View callingView) {
        ...
        returnIntent.putExtra("NewMode", "CONTROL");
